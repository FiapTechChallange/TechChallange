...
CREATE TABLE checkout (id INT AUTO_INCREMENT NOT NULL, id_pedido INT NOT NULL, status VARCHAR(16) CHARACTER SET utf8mb4 DEFAULT 'iniciado' NOT NULL COLLATE `utf8mb4_general_ci`, gateway_pagamento VARCHAR(255) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_general_ci`,  PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_general_ci` ENGINE = InnoDB COMMENT = '';
...
ALTER TABLE checkout ADD CONSTRAINT checkout_pedido_id_fk FOREIGN KEY (id_pedido) REFERENCES pedido (id) ON UPDATE NO ACTION ON DELETE NO ACTION;
